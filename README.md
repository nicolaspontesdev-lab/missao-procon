...
No Windows, dê dois cliques em `JOGAR MISSÃO PROCON.cmd`.

Também é possível abrir o arquivo `index.html` diretamente em qualquer navegador moderno. O jogo funciona offline e não exige instalação, servidor, conta ou dependências externas.
